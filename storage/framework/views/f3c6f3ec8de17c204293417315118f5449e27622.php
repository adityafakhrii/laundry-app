		  ...
		  <?php $no = 1; ?>
		    <?php $__currentLoopData = $transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr class="text-center">			
					...
					<td>Rp<?php echo e($transaksi->paket->harga); ?>,00</td>
				...
				<tr>
					...
					<td>
						<div class="row" style="margin:  auto;">
	                		...
	                		<a href="/riwayat-transaksi" class="btn btn-sm btn-primary" style="margin-left: 57px;"><i class="fas fa-chevron-left"></i> Kembali</a>	
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laundry-ujikom\resources\views/transaksi/detail_r.blade.php ENDPATH**/ ?>