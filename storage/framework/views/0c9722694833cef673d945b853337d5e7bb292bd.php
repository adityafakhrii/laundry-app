                    ...
                    <div class="header">
                        ...
                        <ul class="nav navbar-nav Contact">
                            <?php if(Route::has('login')): ?>
                                <?php if(auth()->guard()->check()): ?>
                                <li class="sign"><a href="/logout"><i class="fas fa-sign-out-alt fa"></i><span class="logout"><?php echo e(auth()->user()->username); ?></span> </a></li>
                                <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\laundry-ujikom\resources\views/tentang.blade.php ENDPATH**/ ?>