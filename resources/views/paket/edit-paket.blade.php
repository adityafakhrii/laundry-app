...
@section('content')
	...
	<form action="/updatepaket/{{$paket->id}}" method="POST" enctype="multipart/form-data">
		@csrf
		<div class="form-row col">
			<div class="form-group col-lg">
				<label for="nama">Nama</label>
				<input type="text" name="nama_paket" id="nama" class="form-control" placeholder="Masukkan nama paket" value="{{$paket->nama_paket}}">
			</div>
			<div class="form-group col-lg">
			...
			<div class="form-group col-lg">
				...
				<input type="text" name="harga" id="harga" class="form-control" placeholder="Masukkan harga" value="{{$paket->harga}}">
			</div>
		</div>
